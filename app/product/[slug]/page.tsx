              ...
              <div key={t} className="border-b border-[#e8e4e0]">
                ...
                {tab === t && (
                  <div className="pb-4 text-xs font-sans text-[#6b6b6b] leading-relaxed">
                    ...
                    {t === 'shipping' && <p>Free shipping on orders above ₹999. Standard delivery 3-5 business days. Express delivery available.</p>}
                    {t === 'returns' && <p>Easy 7-day returns. Item must be unworn with original tags. Raise a return request from your account.</p>}
