...
export default function CategoryShopClient({ category, displayName }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#fafaf8]">
      ...
      {/* ── Products — with Myntra-style left category sidebar on desktop ── */}
          ...
          <div className="flex-1 min-w-0">
            ...
            {!error && (
              <ProductGrid
                ...
                emptySubtext="Check back soon — new styles are on their way."
                emptyAction={<Link href="/shop/" className="text-[11px] font-sans tracking-widest uppercase underline text-[#0a0a0a] hover:text-[#7C4A2D] transition-colors mt-6 inline-block">Browse all collections</Link>}
              />
            )}
          </div>
        </div>
