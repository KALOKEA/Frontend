          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="p-1 text-[#0a0a0a] hover:text-[#c8a4a5] transition-colors"
                aria-label="Search"
              >
              ...
              {/* Wishlist */}
              <Link href={isLoggedIn ? '/account/wishlist' : '/login'} className="p-1 text-[#0a0a0a] hover:text-[#c8a4a5] transition-colors" aria-label="Wishlist">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/>
                </svg>
              </Link>
              {/* Account */}
              <Link href={isLoggedIn ? '/account' : '/login'} className="p-1 text-[#0a0a0a] hover:text-[#c8a4a5] transition-colors" aria-label="Account">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
            ...
            <form onSubmit={handleSearch} className="max-w-2xl mx-auto flex items-center gap-3">
              ...
              {searchQuery && (
                <button
                  ...
                  className="text-[#9b9b9b] hover:text-[#0a0a0a] text-xl leading-none p-1"
                >
                  ×
                </button>
              )}
